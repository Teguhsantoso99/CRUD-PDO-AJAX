...
--
-- Host: 127.0.0.1
-- Generation Time: May 29, 2019 at 09:53 AM
...
('181530028', 'Teguh Santoso', 'teguhcinematography9@gmail.com', '0192023a7bbd73250516f069df18b500', 'Administrator', 1),
('5467', 'Jaka Prayogo dr', 'jaka45@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Administrator', 1),
('7895', 'Naufal', 'Naufal45@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', 'Kasir', 1);
...
ALTER TABLE `pos_barangmasuk`
  ADD PRIMARY KEY (`id_user`,`no_trans`,`id_supplier`);

--
-- Indexes for table `pos_barangmasukdetail`
--
ALTER TABLE `pos_barangmasukdetail`
  ADD PRIMARY KEY (`kd_barang`,`no_trans`);
...
ALTER TABLE `pos_penjualan`
  ADD PRIMARY KEY (`id_user`,`id_member`,`no_trans`);
